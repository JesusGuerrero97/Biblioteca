 ...
 * @author Dania
 */
public class VistaAltaSucursal extends javax.swing.JFrame {

    /**
     * Creates new form VistaLibro
     */
    public VistaAltaSucursal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaAltaSucursal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaAltaSucursal().setVisible(true);
            }
        });
    }
